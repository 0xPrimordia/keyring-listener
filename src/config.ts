...
export interface Config {
  ...
  /** JSON-RPC keepalive interval (ms) via eth_blockNumber; 0 = disabled. Default 60000. */
  wsPingIntervalMs: number;
  /** @deprecated Unused; relay keepalive uses JSON-RPC, not WebSocket ping/pong. */
...
export function loadConfig(): Config {
  ...
  return {
    ...
    wsPingIntervalMs: parsePositiveInt(process.env.WS_PING_INTERVAL_MS, 60000),
